...
{
    public abstract class SoundManager : GameSavableManager
    {
        ...
        public override void OnGameUpdate(GameManager parentManager)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual SoundManager AddSoundSource(string id, float volume)
        {
            //检查id是否存在
        ...
        /// 设置声音源跟随
        /// </summary>
        public virtual SoundManager SetSoundeSourceFollow(string id, Transform follow)
        {
        ...
        /// 设置声音源相对位置
        /// </summary>
        public virtual SoundManager SetSoundSourceLocalPosition(string id, Vector3 localPosition)
        {
            var soundSource = GetSoundSource(id);
            if (soundSource == null)
            {
        ...
        /// 设置声音源音量
        /// </summary>
        public virtual SoundManager SetSoundSourceVolume(string id, float volume, bool transition)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual SoundManager RemoveSoundSource(string id)
        {
        ...
        public virtual SoundManager PlayAudio(string id, AudioClip audioclip, bool loop = false, bool transition = false)
        {
            var soundSource = GetSoundSource(id);

...
|CreateDataTable|bool|string tableName|public|创建数据表|
...
|GetValue|string, bool|string tableName, string key|public|获得某个数据表中的值|
|SetValue|bool|string tableName, string key, string value|public|设置某个数据表中的值|
|SetValue|bool|string tableName, List<KeyValuePair<string, string>> keyValues|public|批量设置某个数据表中的值|
|HasKey|bool|string tableName, string key|public|某个数据表中是否存在键|
|RemoveKey|bool|string tableName, string key|public|移除某个数据表中的键|
...
|方法|返回值|参数|访问级别|备注|
|-|-|-|-|-|
|HasKey|bool|string key|public|返回是否存在键|
|GetValue|string val, bool hasVal|string key|public|获取值|
|SetValue|void|string key, string value|public|设置值|
|Remove|bool|string key|public|移除键|
|GetKeyValues|List<KeyValuePair<string, string>>||public|获取所有键值对|
|Clear|void||public|清空数据表|
